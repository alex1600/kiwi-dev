...
namespace KiwiAttributes.Editor
{
	public abstract class PropertyDrawerBase : PropertyDrawer
	{
		...
		{
			float indentLength = KiwiEditorGUI.GetIndentLength(rect);
			...
			KiwiEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, context: property.serializedObject.targetObject);
