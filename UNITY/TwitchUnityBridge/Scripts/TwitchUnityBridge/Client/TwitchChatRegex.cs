...
namespace TwitchUnityBridge.Client
{
    public static class TwitchChatRegex
    {
        ...
        public static Regex JoinRegex { get; } = new Regex(JoinExpression);
        public static Regex PartRegex { get; } = new Regex(PartExpression);
        public static Regex MessageRegex { get; } = new Regex(MessageExpression);
        public static Regex RewardRegex { get; } = new Regex(RewardExpression);
        public static Regex IdMessageRegex { get; } = new Regex(IdMessageExpression);
        public static Regex CheerRegex { get; } = new Regex(CheerExpression, RegexOptions.IgnoreCase);
